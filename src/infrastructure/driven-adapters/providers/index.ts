...
import { MAKE_RAFFLE_REPOSITORY } from '@/domain/models/contracts/make-raffle-repository';
...
import { MakeRaffleServiceImpl } from '@/domain/use-cases/impl/make-raffle-service-impl';
...
import { MAKE_RAFFLE_SERVICE } from '@/domain/use-cases/make-raffle-service';
...
export const adapters = [
  ...
  {
    provide: MAKE_RAFFLE_REPOSITORY,
...
export const services = [
  ...
  {
    provide: MAKE_RAFFLE_SERVICE,
    useClass: MakeRaffleServiceImpl,
  },
  {
